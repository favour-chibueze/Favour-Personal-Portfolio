            ...
            <div class="container flex justify-center max-w-full items-center h-full gap-10">
                <div class="flex w-[100%] max-w-none mx-auto flex-col justify-center items-start">
                    <div class="lg:w-[86%] mx-auto self-center">
                        ...
                        <div>
                            <p class="font-simula lg:text-2xl mt-3 text-center text-balance italic"> I'm always excited to connect with like-minded individuals.  </p>
                                <p class="font-simula lg:text-2xl mt-1 text-center text-balance italic"> 
